...
export default function EditQuiz() {
    ...
    if (loading) {
        return (_jsxs(_Fragment, { children: [_jsx(AdminNav, {}), _jsx("div", { className: "flex items-center justify-center min-h-screen", children: _jsx("p", { className: "text-black", children: "Loading quiz..." }) })] }));
    }
