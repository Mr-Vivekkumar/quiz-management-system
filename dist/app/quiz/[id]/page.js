...
export default function TakeQuizPage() {
    ...
    if (loading) {
        return (_jsxs(_Fragment, { children: [_jsx(QuizNav, {}), _jsx("div", { className: "min-h-screen flex items-center justify-center", children: _jsx("p", { className: "text-muted", children: "Loading quiz..." }) })] }));
    }
    if (!quiz) {
